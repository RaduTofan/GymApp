...
namespace GymApp.API.Infrastructure.Extensions
{
    ...
    {
        public async static Task<PaginatedResult<TDto>> CreatePaginatedResultAsync<TEntity, TDto>(this IQueryable<TEntity> query, PaginatedRequest pagedRequest, IMapper mapper)
        ...
        private static IQueryable<T> Paginate<T>(this IQueryable<T> query, PaginatedRequest pagedRequest)
        {
